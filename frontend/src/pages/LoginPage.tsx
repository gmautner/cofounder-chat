      ...
      <div className="relative z-10 w-full max-w-sm px-6">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          <a
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl bg-foreground px-5 py-3 text-sm font-medium text-background transition-all hover:opacity-90 cursor-pointer"
          >
          ...
          {isDev && (
            <>
              ...
              <button
                ...
                disabled={devLoading}
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-border px-5 py-3 text-sm font-medium text-foreground transition-colors hover:bg-accent cursor-pointer disabled:opacity-50"
              >
                {devLoading ? (
